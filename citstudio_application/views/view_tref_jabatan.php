...
<article class="module width_full">
    ...
    <div class="module_content">
        ...
        <fieldset>
                <label>ENTRY / EDIT JABATAN</label>
                <input type="hidden" name="t-jabatanID" id="t-jabatanID" value="<?php echo $jabatanID;?>"/>
                <input type="text" name="t-jabatanNama" id="t-jabatanNama" value="<?php echo $jabatanNama;?>"/>
        </fieldset>
        <div class="clear"></div>
    </div>
</article><!-- end of stats article -->
<article class="module width_full">
    <header><h3>DATA JABATAN</h3></header>
    <div class="module_content">
        <table align="center" style="text-align: center;" id="gJabatan"></table>
        <div id="pJabatan"></div>
        <div class="clear"></div>
...
<script type="text/javascript" src="<?php echo base_url().C_JS;?>application/grid-jabatan.js"></script>