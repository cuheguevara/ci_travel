...
//var_dump('http://'.$_SERVER['SERVER_NAME'].'/comprofile/mediauploads');
$opts = array(
	//'root'             => 'http://'.$_SERVER['SERVER_NAME'].'/comprofile/mediauploads', // root directory URL
	'root'            => '../../files',                       // path to root directory
	'URL'             => 'http://dipo.citstudio.com/resource/js/jquery/elfinder/files/', // root directory URL
	//'URL'             => 'http://'.$_SERVER['SERVER_NAME'].'/comprofile/mediauploads/', // root directory URL
